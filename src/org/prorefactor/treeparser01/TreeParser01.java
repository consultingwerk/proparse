...
public TreeParser01() {
	...
	public final void blockorstate(AST _t) throws RecognitionException {
		...
		case ANNOTATION:
		{
			...
			do {
				if (_t==null) _t=ASTNULL;
				if (((_t.getType() >= LEXDATE && _t.getType() <= XOR))) {
		...
		if ((_t.getType()==ASSIGN)) {
			...
			do {
				...
				if ((_t.getType()==EQUAL)) {
					...
					if ( _cnt1791>=1 ) { break _loop1791; } else {throw new NoViableAltException(_t);}
				}
			...
			do {
				...
				if ((_t.getType()==MINUS_EQUAL)) {
					...
					if ( _cnt1799>=1 ) { break _loop1799; } else {throw new NoViableAltException(_t);}
				}
			...
			do {
				...
				if ((_t.getType()==DIVIDE_EQUAL)) {
					...
					if ( _cnt1803>=1 ) { break _loop1803; } else {throw new NoViableAltException(_t);}
				}
			...
			do {
				...
				if ((_t.getType()==MULTIPLY_EQUAL)) {
					...
					if ( _cnt1807>=1 ) { break _loop1807; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void display_with(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2090 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==WITH))) {
			AST __t2090 = _t;
			synPredMatched2090 = true;
			inputState.guessing++;
			try {
				{
				AST __t2089 = _t;
				...
				synPredMatched2090 = false;
			}
			_t = __t2090;
inputState.guessing--;
		}
		if ( synPredMatched2090 ) {
			AST __t2091 = _t;
		...
		case PFCOLOR:
		{
			...
			do {
				...
				if ((_tokenSet_28.member(_t.getType()))) {
					...
					if ( _cnt1867>=1 ) { break _loop1867; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
			...
			else if (((_t.getType() >= LEXDATE && _t.getType() <= XOR))) {
			}
			else {
				throw new NoViableAltException(_t);
			}
...
inputState.guessing--;
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2301>=1 ) { break _loop2301; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2306>=1 ) { break _loop2306; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched2339 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t2339 = _t;
					synPredMatched2339 = true;
					inputState.guessing++;
					try {
						{
						AST __t2337 = _t;
						...
						synPredMatched2339 = false;
					}
					_t = __t2339;
inputState.guessing--;
				}
				if ( synPredMatched2339 ) {
					AST __t2340 = _t;
	...
	public final void case_expression(AST _t) throws RecognitionException {
		...
		boolean synPredMatched1852 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OR))) {
			AST __t1852 = _t;
			synPredMatched1852 = true;
			inputState.guessing++;
			try {
				{
				AST __t1851 = _t;
				...
				synPredMatched1852 = false;
			}
			_t = __t1852;
inputState.guessing--;
		}
		if ( synPredMatched1852 ) {
			AST __t1853 = _t;
	...
	public final void goon_elem(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2137 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OF))) {
			AST __t2137 = _t;
			synPredMatched2137 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched2137 = false;
			}
			_t = __t2137;
inputState.guessing--;
		}
		if ( synPredMatched2137 ) {
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2427 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2427 = _t;
			synPredMatched2427 = true;
			inputState.guessing++;
			try {
				{
				AST __t2426 = _t;
				...
				synPredMatched2427 = false;
			}
			_t = __t2427;
inputState.guessing--;
		}
		if ( synPredMatched2427 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
			boolean synPredMatched2429 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==ERROR))) {
				AST __t2429 = _t;
				synPredMatched2429 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2429 = false;
				}
				_t = __t2429;
inputState.guessing--;
			}
			if ( synPredMatched2429 ) {
