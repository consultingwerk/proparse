...
public TreeParser01() {
	...
	public final void blockorstate(AST _t) throws RecognitionException {
		...
		case ANNOTATION:
		{
			...
			do {
				if (_t==null) _t=ASTNULL;
				if (((_t.getType() >= LEXDATE && _t.getType() <= NULL))) {
...
inputState.guessing--;
	...
	public final void formatphrase(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt921>=1 ) { break _loop921; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt921++;
		} while (true);
	...
	public final void assign_opt(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==EQUAL)) {
				...
				if ( _cnt1779>=1 ) { break _loop1779; } else {throw new NoViableAltException(_t);}
			}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt545>=1 ) { break _loop545; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt548>=1 ) { break _loop548; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void defineproperty_accessor(AST _t) throws RecognitionException {
		...
		case Property_getter:
		{
			...
			_t = _t.getNextSibling();
			{
			boolean synPredMatched2034 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==PERIOD))) {
				AST __t2034 = _t;
				synPredMatched2034 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2034 = false;
				}
				_t = __t2034;
inputState.guessing--;
			}
			if ( synPredMatched2034 ) {
			...
			if ((_t.getType()==INDEX)) {
				...
				do {
					...
					if ((_t.getType()==ID)) {
						...
						if ( _cnt690>=1 ) { break _loop690; } else {throw new NoViableAltException(_t);}
					}
	...
	public final void varstate(AST _t) throws RecognitionException {
		...
		{
		if (_t==null) _t=ASTNULL;
		if ((_t.getType()==EOF||_t.getType()==PERIOD||_t.getType()==COMMA)) {
			{
			_loop726:
			do {
				if (_t==null) _t=ASTNULL;
		...
		else if ((_t.getType()==EOF||_t.getType()==PERIOD||_t.getType()==EQUAL)) {
			{
			if (_t==null) _t=ASTNULL;
			switch ( _t.getType()) {
			case EQUAL:
	...
	public final void varStatementSub(AST _t) throws RecognitionException {
		
		AST varStatementSub_AST_in = (_t == ASTNULL) ? null : (AST)_t;
	...
	public final void aggregatephrase(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_tokenSet_24.member(_t.getType()))) {
				...
				if ( _cnt1760>=1 ) { break _loop1760; } else {throw new NoViableAltException(_t);}
			}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt827>=1 ) { break _loop827; } else {throw new NoViableAltException(_t);}
				}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt897>=1 ) { break _loop897; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void functionstate(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched965 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==IN_KW))) {
				AST __t965 = _t;
				synPredMatched965 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched965 = false;
				}
				_t = __t965;
inputState.guessing--;
			}
			if ( synPredMatched965 ) {
	...
	public final void importstate(AST _t) throws RecognitionException {
		...
		case Field_ref:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1015>=1 ) { break _loop1015; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1015++;
			} while (true);
...
inputState.guessing--;
			...
			else if (((_t.getType() >= LEXDATE && _t.getType() <= NULL))) {
			}
			else {
				throw new NoViableAltException(_t);
			}
...
inputState.guessing--;
	...
	public final void selectstatea(AST _t) throws RecognitionException {
		...
		case Sql_select_what:
		{
			...
			_t = _t.getFirstChild();
			{
			boolean synPredMatched1447 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t1447 = _t;
				synPredMatched1447 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1447 = false;
				}
				_t = __t1447;
inputState.guessing--;
			}
			if ( synPredMatched1447 ) {
		...
		if (((_t.getType()==3||_t.getType()==UNION||_t.getType()==WITH))&&(_t != null)) {
			{
			boolean synPredMatched1476 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType()==WITH))&&(_t != null))) {
				AST __t1476 = _t;
				synPredMatched1476 = true;
				inputState.guessing++;
				try {
					{
					AST __t1475 = _t;
					...
					synPredMatched1476 = false;
				}
				_t = __t1476;
inputState.guessing--;
			}
			if ( synPredMatched1476 ) {
				AST __t1477 = _t;
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2687 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2687 = _t;
				synPredMatched2687 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2687 = false;
				}
				_t = __t2687;
inputState.guessing--;
			}
			if ( synPredMatched2687 ) {
				AST __t2688 = _t;
	...
	public final void statement(AST _t) throws RecognitionException {
		...
		default:
			...
			else if (((_t.getType()==DEFINE))&&(state2(_t, VAR))) {
				definevariablestate(_t);
				_t = _retTree;
			}
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2273>=1 ) { break _loop2273; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2278>=1 ) { break _loop2278; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched2311 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t2311 = _t;
					synPredMatched2311 = true;
					inputState.guessing++;
					try {
						{
						AST __t2309 = _t;
						...
						synPredMatched2311 = false;
					}
					_t = __t2311;
inputState.guessing--;
				}
				if ( synPredMatched2311 ) {
					AST __t2312 = _t;
...
inputState.guessing--;
	...
	public final void goon_elem(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2109 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OF))) {
			AST __t2109 = _t;
			synPredMatched2109 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched2109 = false;
			}
			_t = __t2109;
inputState.guessing--;
		}
		if ( synPredMatched2109 ) {
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2399 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2399 = _t;
			synPredMatched2399 = true;
			inputState.guessing++;
			try {
				{
				AST __t2398 = _t;
				...
				synPredMatched2399 = false;
			}
			_t = __t2399;
inputState.guessing--;
		}
		if ( synPredMatched2399 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
