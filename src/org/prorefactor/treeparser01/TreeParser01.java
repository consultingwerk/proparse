	...
	public final void assign_opt(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==EQUAL)) {
				...
				if ( _cnt1745>=1 ) { break _loop1745; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void display_with(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2028 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==WITH))) {
			AST __t2028 = _t;
			synPredMatched2028 = true;
			inputState.guessing++;
			try {
				{
				AST __t2027 = _t;
				...
				synPredMatched2028 = false;
			}
			_t = __t2028;
inputState.guessing--;
		}
		if ( synPredMatched2028 ) {
			AST __t2029 = _t;
...
inputState.guessing--;
	...
	public final void defineproperty_accessor(AST _t) throws RecognitionException {
		...
		case Property_getter:
		{
			...
			_t = _t.getNextSibling();
			{
			boolean synPredMatched2000 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==PERIOD))) {
				AST __t2000 = _t;
				synPredMatched2000 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2000 = false;
				}
				_t = __t2000;
inputState.guessing--;
			}
			if ( synPredMatched2000 ) {
		...
		case PFCOLOR:
		{
			...
			do {
				...
				if ((_tokenSet_26.member(_t.getType()))) {
					...
					if ( _cnt1805>=1 ) { break _loop1805; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void importstate(AST _t) throws RecognitionException {
		...
		case Field_ref:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt985>=1 ) { break _loop985; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt985++;
			} while (true);
...
inputState.guessing--;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1388>=1 ) { break _loop1388; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1388++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2653 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2653 = _t;
				synPredMatched2653 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2653 = false;
				}
				_t = __t2653;
inputState.guessing--;
			}
			if ( synPredMatched2653 ) {
				AST __t2654 = _t;
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2239>=1 ) { break _loop2239; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2244>=1 ) { break _loop2244; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched2277 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t2277 = _t;
					synPredMatched2277 = true;
					inputState.guessing++;
					try {
						{
						AST __t2275 = _t;
						...
						synPredMatched2277 = false;
					}
					_t = __t2277;
inputState.guessing--;
				}
				if ( synPredMatched2277 ) {
					AST __t2278 = _t;
	...
	public final void case_expression(AST _t) throws RecognitionException {
		...
		boolean synPredMatched1790 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OR))) {
			AST __t1790 = _t;
			synPredMatched1790 = true;
			inputState.guessing++;
			try {
				{
				AST __t1789 = _t;
				...
				synPredMatched1790 = false;
			}
			_t = __t1790;
inputState.guessing--;
		}
		if ( synPredMatched1790 ) {
			AST __t1791 = _t;
...
inputState.guessing--;
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2365 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2365 = _t;
			synPredMatched2365 = true;
			inputState.guessing++;
			try {
				{
				AST __t2364 = _t;
				...
				synPredMatched2365 = false;
			}
			_t = __t2365;
inputState.guessing--;
		}
		if ( synPredMatched2365 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
			boolean synPredMatched2367 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==ERROR))) {
				AST __t2367 = _t;
				synPredMatched2367 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2367 = false;
				}
				_t = __t2367;
inputState.guessing--;
			}
			if ( synPredMatched2367 ) {
