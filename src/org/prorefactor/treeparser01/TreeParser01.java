	...
	public final void assign_opt(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==EQUAL)) {
				...
				if ( _cnt1761>=1 ) { break _loop1761; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void display_with(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2044 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==WITH))) {
			AST __t2044 = _t;
			synPredMatched2044 = true;
			inputState.guessing++;
			try {
				{
				AST __t2043 = _t;
				...
				synPredMatched2044 = false;
			}
			_t = __t2044;
inputState.guessing--;
		}
		if ( synPredMatched2044 ) {
			AST __t2045 = _t;
...
inputState.guessing--;
	...
	public final void defineproperty_accessor(AST _t) throws RecognitionException {
		...
		case Property_getter:
		{
			...
			_t = _t.getNextSibling();
			{
			boolean synPredMatched2016 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==PERIOD))) {
				AST __t2016 = _t;
				synPredMatched2016 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2016 = false;
				}
				_t = __t2016;
inputState.guessing--;
			}
			if ( synPredMatched2016 ) {
	...
	public final void aggregatephrase(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_tokenSet_24.member(_t.getType()))) {
				...
				if ( _cnt1742>=1 ) { break _loop1742; } else {throw new NoViableAltException(_t);}
			}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt809>=1 ) { break _loop809; } else {throw new NoViableAltException(_t);}
				}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt879>=1 ) { break _loop879; } else {throw new NoViableAltException(_t);}
				}
		...
		case PFCOLOR:
		{
			...
			do {
				...
				if ((_tokenSet_27.member(_t.getType()))) {
					...
					if ( _cnt1821>=1 ) { break _loop1821; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void importstate(AST _t) throws RecognitionException {
		...
		case Field_ref:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt997>=1 ) { break _loop997; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt997++;
			} while (true);
...
inputState.guessing--;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1404>=1 ) { break _loop1404; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1404++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2669 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2669 = _t;
				synPredMatched2669 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2669 = false;
				}
				_t = __t2669;
inputState.guessing--;
			}
			if ( synPredMatched2669 ) {
				AST __t2670 = _t;
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2255>=1 ) { break _loop2255; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2260>=1 ) { break _loop2260; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched2293 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t2293 = _t;
					synPredMatched2293 = true;
					inputState.guessing++;
					try {
						{
						AST __t2291 = _t;
						...
						synPredMatched2293 = false;
					}
					_t = __t2293;
inputState.guessing--;
				}
				if ( synPredMatched2293 ) {
					AST __t2294 = _t;
...
inputState.guessing--;
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2381 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2381 = _t;
			synPredMatched2381 = true;
			inputState.guessing++;
			try {
				{
				AST __t2380 = _t;
				...
				synPredMatched2381 = false;
			}
			_t = __t2381;
inputState.guessing--;
		}
		if ( synPredMatched2381 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
			boolean synPredMatched2383 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==ERROR))) {
				AST __t2383 = _t;
				synPredMatched2383 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2383 = false;
				}
				_t = __t2383;
inputState.guessing--;
			}
			if ( synPredMatched2383 ) {
