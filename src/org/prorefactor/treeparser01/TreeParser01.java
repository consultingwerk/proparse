	...
	public final void assign_opt(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==EQUAL)) {
				...
				if ( _cnt1727>=1 ) { break _loop1727; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void display_with(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2009 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==WITH))) {
			AST __t2009 = _t;
			synPredMatched2009 = true;
			inputState.guessing++;
			try {
				{
				AST __t2008 = _t;
				...
				synPredMatched2009 = false;
			}
			_t = __t2009;
inputState.guessing--;
		}
		if ( synPredMatched2009 ) {
			AST __t2010 = _t;
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt522>=1 ) { break _loop522; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt525>=1 ) { break _loop525; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void defineproperty_accessor(AST _t) throws RecognitionException {
		...
		case Property_getter:
		{
			...
			_t = _t.getNextSibling();
			{
			boolean synPredMatched1981 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==PERIOD))) {
				AST __t1981 = _t;
				synPredMatched1981 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1981 = false;
				}
				_t = __t1981;
inputState.guessing--;
			}
			if ( synPredMatched1981 ) {
			...
			if ((_t.getType()==INDEX)) {
				...
				do {
					...
					if ((_t.getType()==ID)) {
						...
						if ( _cnt666>=1 ) { break _loop666; } else {throw new NoViableAltException(_t);}
					}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt716>=1 ) { break _loop716; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void aggregatephrase(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_tokenSet_23.member(_t.getType()))) {
				...
				if ( _cnt1708>=1 ) { break _loop1708; } else {throw new NoViableAltException(_t);}
			}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt785>=1 ) { break _loop785; } else {throw new NoViableAltException(_t);}
				}
		...
		case PFCOLOR:
		{
			...
			do {
				...
				if ((_tokenSet_26.member(_t.getType()))) {
					...
					if ( _cnt1787>=1 ) { break _loop1787; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1370>=1 ) { break _loop1370; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1370++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2633 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2633 = _t;
				synPredMatched2633 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2633 = false;
				}
				_t = __t2633;
inputState.guessing--;
			}
			if ( synPredMatched2633 ) {
				AST __t2634 = _t;
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2225>=1 ) { break _loop2225; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2345 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2345 = _t;
			synPredMatched2345 = true;
			inputState.guessing++;
			try {
				{
				AST __t2344 = _t;
				...
				synPredMatched2345 = false;
			}
			_t = __t2345;
inputState.guessing--;
		}
		if ( synPredMatched2345 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
