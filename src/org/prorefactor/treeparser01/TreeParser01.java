...
public TreeParser01() {
	...
	public final void blockorstate(AST _t) throws RecognitionException {
		...
		case ANNOTATION:
		{
			...
			do {
				if (_t==null) _t=ASTNULL;
				if (((_t.getType() >= LEXDATE && _t.getType() <= PARENTFIELDSAFTER))) {
...
inputState.guessing--;
		...
		case USING:
		{
			...
			do {
				...
				if ((_t.getType()==Field_ref)) {
					...
					if ( _cnt220>=1 ) { break _loop220; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void columnformat(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt296>=1 ) { break _loop296; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt296++;
		} while (true);
	...
	public final void assign_opt(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==EQUAL)) {
				...
				if ( _cnt1705>=1 ) { break _loop1705; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void display_with(AST _t) throws RecognitionException {
		...
		boolean synPredMatched1987 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==WITH))) {
			AST __t1987 = _t;
			synPredMatched1987 = true;
			inputState.guessing++;
			try {
				{
				AST __t1986 = _t;
				...
				synPredMatched1987 = false;
			}
			_t = __t1987;
inputState.guessing--;
		}
		if ( synPredMatched1987 ) {
			AST __t1988 = _t;
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt502>=1 ) { break _loop502; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt505>=1 ) { break _loop505; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void defineproperty_accessor(AST _t) throws RecognitionException {
		...
		case Property_getter:
		{
			...
			_t = _t.getNextSibling();
			{
			boolean synPredMatched1959 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==PERIOD))) {
				AST __t1959 = _t;
				synPredMatched1959 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1959 = false;
				}
				_t = __t1959;
inputState.guessing--;
			}
			if ( synPredMatched1959 ) {
			...
			if ((_t.getType()==INDEX)) {
				...
				do {
					...
					if ((_t.getType()==ID)) {
						...
						if ( _cnt646>=1 ) { break _loop646; } else {throw new NoViableAltException(_t);}
					}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt696>=1 ) { break _loop696; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void aggregatephrase(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_tokenSet_21.member(_t.getType()))) {
				...
				if ( _cnt1686>=1 ) { break _loop1686; } else {throw new NoViableAltException(_t);}
			}
		...
		case PFCOLOR:
		{
			...
			do {
				...
				if ((_tokenSet_24.member(_t.getType()))) {
					...
					if ( _cnt1765>=1 ) { break _loop1765; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
			...
			else if (((_t.getType() >= LEXDATE && _t.getType() <= PARENTFIELDSAFTER))) {
			}
			else {
				throw new NoViableAltException(_t);
			}
...
inputState.guessing--;
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2611 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2611 = _t;
				synPredMatched2611 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2611 = false;
				}
				_t = __t2611;
inputState.guessing--;
			}
			if ( synPredMatched2611 ) {
				AST __t2612 = _t;
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2198>=1 ) { break _loop2198; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2203>=1 ) { break _loop2203; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2323 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2323 = _t;
			synPredMatched2323 = true;
			inputState.guessing++;
			try {
				{
				AST __t2322 = _t;
				...
				synPredMatched2323 = false;
			}
			_t = __t2323;
inputState.guessing--;
		}
		if ( synPredMatched2323 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
