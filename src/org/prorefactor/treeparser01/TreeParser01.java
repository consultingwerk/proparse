...
inputState.guessing--;
	...
	public final void formatphrase(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt925>=1 ) { break _loop925; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt925++;
		} while (true);
	...
	public final void assign_opt(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==EQUAL)) {
				...
				if ( _cnt1783>=1 ) { break _loop1783; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void display_with(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2066 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==WITH))) {
			AST __t2066 = _t;
			synPredMatched2066 = true;
			inputState.guessing++;
			try {
				{
				AST __t2065 = _t;
				...
				synPredMatched2066 = false;
			}
			_t = __t2066;
inputState.guessing--;
		}
		if ( synPredMatched2066 ) {
			AST __t2067 = _t;
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt762>=1 ) { break _loop762; } else {throw new NoViableAltException(_t);}
				}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt831>=1 ) { break _loop831; } else {throw new NoViableAltException(_t);}
				}
		...
		case PFCOLOR:
		{
			...
			do {
				...
				if ((_tokenSet_27.member(_t.getType()))) {
					...
					if ( _cnt1843>=1 ) { break _loop1843; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void importstate(AST _t) throws RecognitionException {
		...
		case Field_ref:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1019>=1 ) { break _loop1019; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1019++;
			} while (true);
...
inputState.guessing--;
		...
		_t = _retTree;
		{
		boolean synPredMatched1068 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==PERIOD||_t.getType()==LEXCOLON))) {
			AST __t1068 = _t;
			synPredMatched1068 = true;
			inputState.guessing++;
			try {
				{
				block_colon(_t);
				...
				synPredMatched1068 = false;
			}
			_t = __t1068;
inputState.guessing--;
		}
		if ( synPredMatched1068 ) {
			block_colon(_t);
			_t = _retTree;
			code_block(_t);
			_t = _retTree;
...
inputState.guessing--;
		...
		if (((_t.getType()==3||_t.getType()==UNION||_t.getType()==WITH))&&(_t != null)) {
			{
			boolean synPredMatched1480 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType()==WITH))&&(_t != null))) {
				AST __t1480 = _t;
				synPredMatched1480 = true;
				inputState.guessing++;
				try {
					{
					AST __t1479 = _t;
					...
					synPredMatched1480 = false;
				}
				_t = __t1480;
inputState.guessing--;
			}
			if ( synPredMatched1480 ) {
				AST __t1481 = _t;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1426>=1 ) { break _loop1426; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1426++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2691 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2691 = _t;
				synPredMatched2691 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2691 = false;
				}
				_t = __t2691;
inputState.guessing--;
			}
			if ( synPredMatched2691 ) {
				AST __t2692 = _t;
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2277>=1 ) { break _loop2277; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2282>=1 ) { break _loop2282; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void goon_elem(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2113 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OF))) {
			AST __t2113 = _t;
			synPredMatched2113 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched2113 = false;
			}
			_t = __t2113;
inputState.guessing--;
		}
		if ( synPredMatched2113 ) {
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2403 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2403 = _t;
			synPredMatched2403 = true;
			inputState.guessing++;
			try {
				{
				AST __t2402 = _t;
				...
				synPredMatched2403 = false;
			}
			_t = __t2403;
inputState.guessing--;
		}
		if ( synPredMatched2403 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
			boolean synPredMatched2405 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==ERROR))) {
				AST __t2405 = _t;
				synPredMatched2405 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2405 = false;
				}
				_t = __t2405;
inputState.guessing--;
			}
			if ( synPredMatched2405 ) {
