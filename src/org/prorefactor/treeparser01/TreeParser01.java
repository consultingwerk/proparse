...
inputState.guessing--;
		...
		_t = _retTree;
		{
		boolean synPredMatched1067 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==PERIOD||_t.getType()==LEXCOLON))) {
			AST __t1067 = _t;
			synPredMatched1067 = true;
			inputState.guessing++;
			try {
				{
				block_colon(_t);
				...
				synPredMatched1067 = false;
			}
			_t = __t1067;
inputState.guessing--;
		}
		if ( synPredMatched1067 ) {
			block_colon(_t);
			_t = _retTree;
			code_block(_t);
			_t = _retTree;
...
inputState.guessing--;
		...
		if (((_t.getType()==3||_t.getType()==UNION||_t.getType()==WITH))&&(_t != null)) {
			{
			boolean synPredMatched1479 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType()==WITH))&&(_t != null))) {
				AST __t1479 = _t;
				synPredMatched1479 = true;
				inputState.guessing++;
				try {
					{
					AST __t1478 = _t;
					...
					synPredMatched1479 = false;
				}
				_t = __t1479;
inputState.guessing--;
			}
			if ( synPredMatched1479 ) {
				AST __t1480 = _t;
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2690 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2690 = _t;
				synPredMatched2690 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2690 = false;
				}
				_t = __t2690;
inputState.guessing--;
			}
			if ( synPredMatched2690 ) {
				AST __t2691 = _t;
...
inputState.guessing--;
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2402 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2402 = _t;
			synPredMatched2402 = true;
			inputState.guessing++;
			try {
				{
				AST __t2401 = _t;
				...
				synPredMatched2402 = false;
			}
			_t = __t2402;
inputState.guessing--;
		}
		if ( synPredMatched2402 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
