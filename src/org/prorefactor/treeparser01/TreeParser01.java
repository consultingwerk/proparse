		...
		if ((_t.getType()==ASSIGN)) {
			...
			do {
				...
				if ((_t.getType()==MINUS_EQUAL)) {
					...
					if ( _cnt1798>=1 ) { break _loop1798; } else {throw new NoViableAltException(_t);}
				}
			...
			do {
				...
				if ((_t.getType()==DIVIDE_EQUAL)) {
					...
					if ( _cnt1802>=1 ) { break _loop1802; } else {throw new NoViableAltException(_t);}
				}
			...
			do {
				...
				if ((_t.getType()==MULTIPLY_EQUAL)) {
					...
					if ( _cnt1806>=1 ) { break _loop1806; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void display_with(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2089 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==WITH))) {
			AST __t2089 = _t;
			synPredMatched2089 = true;
			inputState.guessing++;
			try {
				{
				AST __t2088 = _t;
				...
				synPredMatched2089 = false;
			}
			_t = __t2089;
inputState.guessing--;
		}
		if ( synPredMatched2089 ) {
			AST __t2090 = _t;
...
inputState.guessing--;
	...
	public final void defineproperty_accessor(AST _t) throws RecognitionException {
		...
		case Property_getter:
		{
			...
			_t = _t.getNextSibling();
			{
			boolean synPredMatched2061 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==PERIOD))) {
				AST __t2061 = _t;
				synPredMatched2061 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2061 = false;
				}
				_t = __t2061;
inputState.guessing--;
			}
			if ( synPredMatched2061 ) {
		...
		case PFCOLOR:
		{
			...
			do {
				...
				if ((_tokenSet_28.member(_t.getType()))) {
					...
					if ( _cnt1866>=1 ) { break _loop1866; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2714 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2714 = _t;
				synPredMatched2714 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2714 = false;
				}
				_t = __t2714;
inputState.guessing--;
			}
			if ( synPredMatched2714 ) {
				AST __t2715 = _t;
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2300>=1 ) { break _loop2300; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2305>=1 ) { break _loop2305; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched2338 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t2338 = _t;
					synPredMatched2338 = true;
					inputState.guessing++;
					try {
						{
						AST __t2336 = _t;
						...
						synPredMatched2338 = false;
					}
					_t = __t2338;
inputState.guessing--;
				}
				if ( synPredMatched2338 ) {
					AST __t2339 = _t;
	...
	public final void case_expression(AST _t) throws RecognitionException {
		...
		boolean synPredMatched1851 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OR))) {
			AST __t1851 = _t;
			synPredMatched1851 = true;
			inputState.guessing++;
			try {
				{
				AST __t1850 = _t;
				...
				synPredMatched1851 = false;
			}
			_t = __t1851;
inputState.guessing--;
		}
		if ( synPredMatched1851 ) {
			AST __t1852 = _t;
...
inputState.guessing--;
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2426 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2426 = _t;
			synPredMatched2426 = true;
			inputState.guessing++;
			try {
				{
				AST __t2425 = _t;
				...
				synPredMatched2426 = false;
			}
			_t = __t2426;
inputState.guessing--;
		}
		if ( synPredMatched2426 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
