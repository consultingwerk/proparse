			...
			case IMAGEDOWN:
			{
				...
				do {
					...
					if ((_tokenSet_9.member(_t.getType()))) {
						...
						if ( _cnt966>=1 ) { break _loop966; } else {throw new NoViableAltException(_t);}
					}
			...
			case IMAGE:
			{
				...
				do {
					...
					if ((_tokenSet_9.member(_t.getType()))) {
						...
						if ( _cnt969>=1 ) { break _loop969; } else {throw new NoViableAltException(_t);}
					}
			...
			case IMAGEUP:
			{
				...
				do {
					...
					if ((_tokenSet_9.member(_t.getType()))) {
						...
						if ( _cnt972>=1 ) { break _loop972; } else {throw new NoViableAltException(_t);}
					}
			...
			case IMAGEINSENSITIVE:
			{
				...
				do {
					...
					if ((_tokenSet_9.member(_t.getType()))) {
						...
						if ( _cnt975>=1 ) { break _loop975; } else {throw new NoViableAltException(_t);}
					}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1051>=1 ) { break _loop1051; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1054>=1 ) { break _loop1054; } else {throw new NoViableAltException(_t);}
				}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1359>=1 ) { break _loop1359; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1440>=1 ) { break _loop1440; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void importstate(AST _t) throws RecognitionException {
		...
		case Field_ref:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1594>=1 ) { break _loop1594; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1594++;
			} while (true);
...
inputState.guessing--;
	...
	public final void onstate(AST _t) throws RecognitionException {
		...
		_t = _t.getFirstChild();
		{
		boolean synPredMatched1735 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_15.member(_t.getType())))) {
			AST __t1735 = _t;
			synPredMatched1735 = true;
			inputState.guessing++;
			try {
				{
				if (_t==null) _t=ASTNULL;
				...
				synPredMatched1735 = false;
			}
			_t = __t1735;
inputState.guessing--;
		}
		if ( synPredMatched1735 ) {
			{
			if (_t==null) _t=ASTNULL;
			switch ( _t.getType()) {
			case CREATE:
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt1834>=1 ) { break _loop1834; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt1839>=1 ) { break _loop1839; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void updatestatement(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2327 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==UPDATE))) {
			AST __t2327 = _t;
			synPredMatched2327 = true;
			inputState.guessing++;
			try {
				{
				AST __t2326 = _t;
				...
				synPredMatched2327 = false;
			}
			_t = __t2327;
inputState.guessing--;
		}
		if ( synPredMatched2327 ) {
			sqlupdatestate(_t);
			_t = _retTree;
		}
...
inputState.guessing--;
		...
		case PFCOLOR:
		{
			...
			do {
				...
				if ((_tokenSet_42.member(_t.getType()))) {
					...
					if ( _cnt608>=1 ) { break _loop608; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void formatphrase(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt1461>=1 ) { break _loop1461; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt1461++;
		} while (true);
	...
	public final void columnformat(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt648>=1 ) { break _loop648; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt648++;
		} while (true);
...
inputState.guessing--;
	...
	public final void menu_list_item(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched1101 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==PERIOD))) {
			AST __t1101 = _t;
			synPredMatched1101 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched1101 = false;
			}
			_t = __t1101;
inputState.guessing--;
		}
		if ( synPredMatched1101 ) {
	...
	public final void defineparam_var(AST _t) throws RecognitionException {
		...
		if ((_t.getType()==AS)) {
			...
			_t = _t.getFirstChild();
			{
			boolean synPredMatched1131 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==HANDLE))) {
				AST __t1131 = _t;
				synPredMatched1131 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1131 = false;
				}
				_t = __t1131;
inputState.guessing--;
			}
			if ( synPredMatched1131 ) {
...
inputState.guessing--;
	...
	public final void function_param_arg(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched1535 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==ID))) {
				AST __t1535 = _t;
				synPredMatched1535 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1535 = false;
				}
				_t = __t1535;
inputState.guessing--;
			}
			if ( synPredMatched1535 ) {
...
inputState.guessing--;
	...
	public final void goon_elem(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched1559 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OF))) {
			AST __t1559 = _t;
			synPredMatched1559 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched1559 = false;
			}
			_t = __t1559;
inputState.guessing--;
		}
		if ( synPredMatched1559 ) {
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2035 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_4.member(_t.getType())))) {
			AST __t2035 = _t;
			synPredMatched2035 = true;
			inputState.guessing++;
			try {
				{
				AST __t2034 = _t;
				...
				synPredMatched2035 = false;
			}
			_t = __t2035;
inputState.guessing--;
		}
		if ( synPredMatched2035 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
			boolean synPredMatched2037 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==ERROR))) {
				AST __t2037 = _t;
				synPredMatched2037 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2037 = false;
				}
				_t = __t2037;
inputState.guessing--;
			}
			if ( synPredMatched2037 ) {
	...
	public final void selectstatea(AST _t) throws RecognitionException {
		...
		case Sql_select_what:
		{
			...
			_t = _t.getFirstChild();
			{
			boolean synPredMatched2496 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2496 = _t;
				synPredMatched2496 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2496 = false;
				}
				_t = __t2496;
inputState.guessing--;
			}
			if ( synPredMatched2496 ) {
		...
		if (((_t.getType()==3||_t.getType()==UNION||_t.getType()==WITH))&&(_t != null)) {
			{
			boolean synPredMatched2525 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType()==WITH))&&(_t != null))) {
				AST __t2525 = _t;
				synPredMatched2525 = true;
				inputState.guessing++;
				try {
					{
					AST __t2524 = _t;
					...
					synPredMatched2525 = false;
				}
				_t = __t2525;
inputState.guessing--;
			}
			if ( synPredMatched2525 ) {
				AST __t2526 = _t;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt2460>=1 ) { break _loop2460; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt2460++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2632 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2632 = _t;
				synPredMatched2632 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2632 = false;
				}
				_t = __t2632;
inputState.guessing--;
			}
			if ( synPredMatched2632 ) {
				AST __t2633 = _t;
