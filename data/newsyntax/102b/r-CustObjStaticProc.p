...
r-CustObjStatic:CustHasInvoices:Subscribe( "CustHasInvoices_Handler" ) NO-ERROR.
...
r-CustObjStatic:GetHighCustomerData( OUTPUT DATASET dsHighCustData BIND ) NO-ERROR.
